	...
	return (
		<form onSubmit={handleSubmit}>
			...
			</div>
			{
				...
				<label className="form-control-label"><FormattedMessage id="contact.countrys"/></label>
			   <SearchBar setSelectedCountry={setSelectedCountry} data={countrys}/>
			</div>:""
			}
			<div className="form-group">
				<label className="form-control-label"><FormattedMessage id="contact.body"/></label>
				<textarea className={`form-control ${styles.textArea}`} name="text" onChange={handleChange}></textarea>
 
			</div>
			<button type="submit" className="btn btn-block bg-dark text-white"><FormattedMessage id="contact.button"/></button>
		</form>
	)
}
